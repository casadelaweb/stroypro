...
function App() {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function Navigation() {
            ...
            const firstElements = [links[0], contents[0]];
            ...
            document.addEventListener("scroll", function () {
                ...
                let offset = nav.querySelector(".navigation-top").offsetHeight;
        ...
        document.addEventListener("click", function (event) {
            ...
            if (event.target.closest("[data-toggle]")) {
                ...
                let selectors = button.getAttribute("data-toggle").replace(/\s/g, "").split(",");
            ...
            if (event.target.closest("[data-menu-next]")) {
                let button = event.target.closest("[data-menu-next]");
                let parent = button.parentNode;
                let layer = parent.querySelector("[data-menu-layer]");
            ...
            // Кнопка назад в меню
                ...
                let button = event.target.closest("[data-menu-prev]");
                let current = {
                    layer: button.closest("[data-menu-layer]"),
                };
            ...
            if (event.target.closest("[data-tab]")) {
                // Переключаем вкладки
                let targetSelector = event.target.closest("[data-tab]").getAttribute("data-tab");
            ...
            if (event.target.closest("[data-add-to-cart]")) {
                let icons = [document.querySelector(".navigation-cart-quantity"), document.querySelector(".navigation-mobile-cart-quantity")];
            ...
            if (event.target.closest(".quantity-button")) {
                ...
                if (current.button.classList.contains("quantity-button-decrement")) {
                    ...
                    let min = current.input.getAttribute("data-value-min") ? parseInt(current.input.getAttribute("data-value-min")) : 0;
        ...
        document.addEventListener("focusout", function (event) {
            ...
            if (
                ...
                let note = input.parentNode.querySelector(".form-input-note");
        ...
        if (catalogRangeSlider) {
            ...
            inputMin.addEventListener("change", function () {
                catalogRangeSlider.noUiSlider.set([this.value, null]);
            });

            inputMax.addEventListener("change", function () {
                catalogRangeSlider.noUiSlider.set([null, this.value]);
            });
        }
    });
}
