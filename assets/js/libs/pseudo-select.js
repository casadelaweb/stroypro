...
export default class PseudoSelect {
    ...
    checkIfValid(select) {
        let current = select.querySelector(".pseudo-select-current");
        let main = select.querySelector(".pseudo-select-main");
    ...
    closeAllSelects() {
        ...
        let selectors = [".pseudo-select", ".pseudo-select-icon", ".pseudo-select-main", ".pseudo-select-list"];
    ...
    markSelectedItems(select) {
        ...
        let list = select.querySelector(".pseudo-select-list");
        let current = select.querySelector(".pseudo-select-current");
        let placeholder = select.querySelector(".pseudo-select-placeholder");
        // Собираем все инпуты внутри списка
        list.querySelectorAll("input").forEach((input) => {
            let item = input.closest(".pseudo-select-list-item");
